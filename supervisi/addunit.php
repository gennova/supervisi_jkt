...
<body>
  ...
  <div id="kanan">
    <div id="header">
	  ...
	  <h1>Tambah Data Unit Kerja YPII</h1>  
	...
	<?php 
       ...
       <table style="width:100%">
		<form action="prosesunit.php" method="POST">
  <tr>
    <td width="100px"><label for="sb">Nama Unit</label></td>
    <td ><input type="text" id="nunit" name="nunit"></td>		
  </tr>  
  <tr><td></td><td><input type="submit" value="Tambahkan"></td></tr>
   </form>
</table>
		<?php
            mysqli_close($con);
